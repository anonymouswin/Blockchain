...
|  *****     File:   fine.cpp                                *****  |
|  *****  Created:   on Sep 4, 2018, 09:46 PM                *****  |
*********************************************************************
...
//		cout<<"!!!!!!!   Fine-Grain Miner Thread Started         !!!!!!\n";
		...
		tTime[0] = Ltimer.timeReq() - start; //! Stop timer.
	...
	static void concMiner( int t_ID, int numAUs, Graph *cGraph)
	{
		...
		while(curInd < numAUs)
		{
			...
			if (flag == true)
			{
				...
				{
					int i = 0;
					//! find the conf_AU_ID in map 
					//! table given conflicting time-stamp.
					while(*it != mAUT[i])
					i = (i+1)%numAUs; 
...
//			<<" Over =====================\n"<<endl;
	...
	//! to get total avg miner and validator time 
	//! after number of totalRun runs.
