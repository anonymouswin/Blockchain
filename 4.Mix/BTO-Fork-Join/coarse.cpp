/********************************************************************
|  *****      Mix Contract BTO Miner + Fork-Join Validator   *****  |
|  *****     File:   coarse.cpp                              *****  |
|  *****  Created:   Oct 06, 2018, 10:16 AM                  *****  |
*********************************************************************
...
//		auction->AuctionEnded_m( );
	...
	void finalState()
	{
		...
		{
			int bal = 0, ts;
			//! get_bal_m() of smart contract, execute again if tryCommit fails.
...
public:
	...
	//!---------------------------------------
	//! CREATE MASTER VALIDATOR THREADS:     !
	//! WHICH CREATES n WORKER THREAD TO     !
	//! EXECUTE VALID AUs IN CONFLICT GRAPH. !
	//!---------------------------------------
	void mainValidator()
	{
		Timer vTimer;
...
//		auction->AuctionEnded( );
	...
	//!----------------------------------------------
	//! FUN TO BE EXECUTED BY ALL VALIDATOR THREADS.!
	//!----------------------------------------------
...
int main( )
{
	...
	cout<<pl<<"Mixed BTO Coarse Grain Fork-Join Algorithm \n"<<pl;
	int totalRun = 1;
